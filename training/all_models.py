...
# from keras.layers.normalization.batch_normalization import BatchNormalization     ###################### WORKAROUND FOR venv 37 (tensorflow latest)
from tensorflow.python.keras.layers import CuDNNGRU, CuDNNLSTM
from tensorflow.python.keras.layers import Dense, Dropout, Conv1D, BatchNormalization
...
import sys
sys.path.append('D:/freeEdu/Edge-Detect-master')
from recurrent_fast import LSTM, GRU
